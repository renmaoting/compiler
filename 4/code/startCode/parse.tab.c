...
static const yytype_uint16 yyrline[] =
{
     ...
     142,   143,   144,   145,   146,   147,   150,   152,   155,   156,
     159,   160,   163,   166,   169,   170,   171,   172,   173,   176,
     179,   182,   183,   186,   189,   190,   193,   194,   197,   198,
     201,   202,   205,   208,   209,   212,   213,   216,   217,   220,
     221,   222,   225,   226,   229,   230,   233,   236,   237,   240,
     241,   244,   245,   248,   249,   252,   253,   256,   257,   258,
     259,   260,   261,   262,   263,   266,   267,   270,   271,   274,
     275,   278,   279,   282,   283,   286,   287,   290,   291,   294,
     295,   298,   301,   302,   305,   306,   309,   310,   313,   314,
     317,   318,   322,   323,   326,   327,   330,   331,   334,   335,
     338,   339,   348,   349,   352,   353,   356,   357,   360,   361,
     364,   365,   368,   369,   372,   373,   374,   375,   376,   377,
     378,   379,   380,   381,   382,   386,   387,   390,   391,   394,
     395,   398,   399,   402,   403,   406,   407,   414,   415,   418,
     419,   442,   443,   444,   445,   448,   454,   457,   458,   459,
     462,   463,   466,   467,   470,   471,   472,   473,   474,   475,
     476,   479,   480,   483,   484,   487,   488,   491,   492,   495,
     496,   499,   500,   503,   504,   507,   508,   511,   512,   513,
     516,   519,   520,   521,   524,   525,   528,   529,   532,   533,
     ...
     617,   618,   621,   622,   623,   626,   627,   628,   631,   632,
     633,   636,   637,   638,   641,   642,   643,   647,   648,   649,
     652,   653,   654,   657,   658,   659,   662,   665,   668,   669,
     670,   673,   674,   675
};
#endif
...
#line 408 "parse.y" /* yacc.c:1646  */
    {
        if((yyvsp[-1]) == PLUS)  (yyval) = (yyvsp[-2]) + (yyvsp[0]); 
        else if((yyvsp[-1]) == MINUS)  (yyval) = (yyvsp[-2]) - (yyvsp[0]); 
    }
    ...
    {   
        switch ((yyvsp[-1])){
            case STAR:
                ...
                break;
            case SLASH:
                if((yyvsp[0])==0 || (yyvsp[-2]) == 0) (yyval) = 0;
                else (yyval) = floor((float)(yyvsp[-2])/(float)(yyvsp[0]));
                break;
            case PERCENT:
                if((yyvsp[0])==0 || (yyvsp[-2]) == 0) (yyval) = 0;
                else (yyval) = (yyvsp[-2]) -(yyvsp[0]) * floor((float)(yyvsp[-2])/(float)(yyvsp[0]));
                break;
            case DOUBLESLASH:
                if((yyvsp[0])==0 || (yyvsp[-2]) == 0) (yyval) = 0;
                else (yyval) = floor((float)(yyvsp[-2])/(float)(yyvsp[0]));
...
#line 449 "parse.y" /* yacc.c:1646  */
    {
        if((yyvsp[-1]) == PLUS) (yyval) = (yyvsp[0]);
        else if((yyvsp[-1]) == MINUS) (yyval) = -(yyvsp[0]);
        else if((yyvsp[-1]) == TILDE) (yyval) = ~(yyvsp[0]);
    }
