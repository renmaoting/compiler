...
#line 208 "parse.tab.c" /* yacc.c:355  */
};
...
static const yytype_uint16 yyrline[] =
{
     ...
     170,   171,   174,   177,   180,   181,   182,   183,   184,   187,
     190,   193,   194,   197,   200,   201,   204,   205,   208,   209,
     212,   213,   216,   219,   220,   223,   224,   227,   228,   231,
     232,   233,   236,   237,   240,   241,   244,   247,   248,   251,
     252,   255,   256,   259,   260,   263,   264,   267,   268,   269,
     270,   271,   272,   273,   274,   277,   278,   281,   282,   285,
     286,   289,   290,   293,   294,   297,   298,   301,   302,   305,
     306,   309,   312,   313,   316,   317,   320,   321,   324,   325,
     328,   329,   333,   334,   337,   338,   341,   342,   345,   346,
     349,   350,   359,   360,   363,   364,   367,   368,   371,   372,
     375,   376,   379,   380,   383,   384,   385,   386,   387,   388,
     389,   390,   391,   392,   393,   397,   398,   401,   402,   405,
     406,   409,   410,   413,   414,   417,   418,   425,   426,   429,
     430,   453,   454,   455,   456,   459,   465,   468,   469,   470,
     473,   474,   477,   478,   481,   482,   483,   484,   485,   486,
     487,   490,   491,   494,   495,   498,   499,   502,   503,   506,
     507,   510,   511,   514,   515,   518,   519,   522,   523,   524,
     527,   530,   531,   532,   535,   536,   539,   540,   543,   544,
     547,   551,   554,   555,   558,   559,   562,   563,   566,   567,
     570,   571,   574,   575,   576,   577,   578,   579,   582,   583,
     586,   587,   590,   591,   594,   595,   598,   599,   602,   603,
     607,   608,   611,   612,   615,   616,   619,   623,   624,   627,
     628,   629,   632,   633,   634,   637,   638,   639,   642,   643,
     644,   647,   648,   649,   652,   653,   654,   658,   659,   660,
     663,   664,   665,   668,   669,   670,   673,   676,   679,   680,
     681,   684,   685,   686
};
#endif
...
#line 425 "parse.y" /* yacc.c:1646  */
    { (yyval.i) = PLUS; }
#line 1820 "parse.tab.c" /* yacc.c:1646  */
    break;
...
#line 431 "parse.y" /* yacc.c:1646  */
    {   
        switch ((yyvsp[-1].i)){
            ...
            case PERCENT:
                if((yyvsp[0].ast)==0 || (yyvsp[-2].ast) == 0) (yyval.ast) = 0;
                else (yyval.ast) =  0; //$1 -$3 * floor((float)$1/(float)$3);
                break;
            case DOUBLESLASH:
                if((yyvsp[0].ast)==0 || (yyvsp[-2].ast) == 0) (yyval.ast) = 0;
                else (yyval.ast) = new DividNode((yyvsp[-2].ast), (yyvsp[0].ast)); //floor((float)$1/(float)$3);
...
#line 460 "parse.y" /* yacc.c:1646  */
    {
        ...
        else if((yyvsp[-1].i) == TILDE) (yyval.ast) = new TildeNode((yyvsp[0].ast), NULL);
    }
